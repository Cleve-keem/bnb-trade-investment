...
// import { zodResolver } from "@hookform/resolvers/zod";
// import { Eye, EyeOff, Loader2, LucideIcon, UserPlus, X } from "lucide-react";
...
//   { id: 1, name: "Username", fieldName: "username", type: "text", icon: null },
//   { id: 2, name: "Fullname", fieldName: "fullname", type: "text", icon: null },
//   {
//     id: 3,
//     name: "Email Address",
//     fieldName: "email",
...
//     handleSubmit,
//     formState: { errors },
//   } = useForm<AdminRegistrationField>({
//     resolver: zodResolver(adminRegistrationConstants),
//   });
...
//         {/* Form */}
//         <form onSubmit={handleSubmit(data)} className="space-y-6 p-5 sm:p-6">
//           {error && (
//             <div className="rounded-xl border border-red-500/20 bg-red-500/10 px-4 py-3 text-sm text-red-400">
//               {error}
//             </div>
...
//         {label}
//         {required && <span className="ml-1 text-[#f0b90b]">*</span>}
//       </span>
//       {children}
//     </label>
//   );
...
//         type="button"
//         onClick={onToggle}
//         className="absolute right-3 top-1/2 -translate-y-1/2 rounded-lg p-1.5 text-zinc-600 transition hover:text-zinc-300"
//       >
